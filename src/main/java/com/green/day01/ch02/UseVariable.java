...
public class UseVariable {
    public static void main(String[] args) {
        // 변수
        int num1; // 변수 선언, 더 정확이 표현: 정수형의 num1이라는 변수명을 가진 정수형을 선언
        //int 데이터타입 (이 변수에 들어갈 수 있는 데이터를 한정/제한)
        // num1 변수명(사용할 때 쓰는 이름)
        // 데이터를 주입할 때는 대입 연산자를 사용한다.

        num1 = 10; // '=' 대입연산자, 오른쪽 항에 있는 값을 복사하여 왼쪽행에 준다.
        ...
        * <변수를 사용하는 이유>
        * 0. 데이터를 저장하기 위해서
        * 1. 여러군대에서 사용을 할 때 참고할 수 있도록 한다.
        *    값이 변경되었을 때 변수값만 수정을 하면 모두 변경이 되기 때문
        * */
    }
}
