...
public class PrintFormat {
    public static void main(String[] args) {
        ...
        */
        ...
        // 홍길동의 나이는 22살 키는 172.5cm 혈액형은 O형입니다. 그는 남자 입니까? true

        System.out.println(name + "의 나이는 " + age + "살 키는 "
                + height + "cm 혈액형은 "  +bloodType
                + "형입니다. 그는 남자 입니까? " + isMan);

        System.out.printf("%s의 나이는 %d살 키는 %.1fcm 형액형은 %c형입니다. 그는 남자 입니까? %b \n"
                        , name, age, height, bloodType, isMan);

        System.out.printf("%s의 나이는 %s살 키는 %scm 형액형은 %s형입니다. 그는 남자 입니까? %b \n"
                        , name, age, height, bloodType, isMan);

        // %f 사이에 값을 주어서 기능을 활용할 수 있다. 12는 총 12칸을 차지한다.
